using ArdalisCA.Core.Entities;
using ArdalisCA.Core.Events;
using ArdalisCA.Core.Interfaces;
using ArdalisCA.Core.Services;
using Moq;
using System;
...
namespace ArdalisCA.UnitTests.Core.Entities
{
